...
INSERT INTO Events(Title, ShortDescription, Text) VALUES('<xsl:value-of select="title"></xsl:value-of>', '<xsl:value-of select="subtitle"></xsl:value-of>', '<xsl:value-of select="annotation"></xsl:value-of>');
