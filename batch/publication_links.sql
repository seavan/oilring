...
--    select * from #mytemp where au_id = @au_id
	...
	SET rowcount @ri
	SELECT * INTO #myPublicationLinks FROM PublicationLinks ORDER BY NEWID()
	...
	begin
		...
		INSERT INTO _PublicationLinks VALUES(@au_id, @obj_type, @t_id, @t_type)
		INSERT INTO _PublicationLinks VALUES(@t_id, @t_type, @au_id, @obj_type)
