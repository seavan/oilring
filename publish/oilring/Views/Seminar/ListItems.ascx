...
<li>
    <div class="bgWrap">
        ...
        <div class="descr <%= OilringExtension.DefaultPhotoAvailable(item) ? "fotoIn" : "" %>">
            ...
            <div class="source" style="display: none">// Семинар из цикла <a href="#">Геология среди нас</a></div>
            ...
            <dl class="info">
                ...
                <dt>Семинар проводят:</dt><% (new OrganizationModule(item) { Relation = "Organizers", ViewName = "RelatedListWidget"}).ListWidget(Html); %>
            </dl>
        </div>
        ...
        <div class="comment">
            ...
            <span class="_universalPeopleDoor peopleDoor borderTop10"><span>На семинар записаны</span> (<%= item.AUTO_ObjectUserVisitorCount %>)</span>
            <!-- при клике добавляем show -->
