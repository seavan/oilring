<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<IEnumerable<admin.db.ConferenceObject>>"  MasterPageFile="~/Views/Shared/MainInner.master" %>
<asp:Content ContentPlaceHolderID="m_Middle" ID="m1" runat="server">
    <% var obj = new ConferenceModule() { PageSize = 5 }.LinkRouteData();%>
    <div class="seminarsBlockIn">
        ...
        <div class="filtrBlock">
            ...
            <ul class="filtr">
                <li class=" borderAll10 _moduleAction _sortComing" rel="sort" rev="<%= obj.ModuleId %>"><span>Ближайшие</span></li>
