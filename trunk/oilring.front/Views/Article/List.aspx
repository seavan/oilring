<%@ Page Language="C#" Inherits="System.Web.Mvc.ViewPage<IEnumerable<admin.db.ArticleObject>>"  MasterPageFile="~/Views/Shared/MainInner.master"%>
<asp:Content ContentPlaceHolderID="m_Middle" ID="m1" runat="server">
<div class="materialBlockIn">
    <% var obj = new ArticleModule() { PageSize = 5 }.LinkRouteData();%>
    <!--фильтр-->
