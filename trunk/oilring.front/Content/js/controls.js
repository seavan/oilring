        ...
        (function () {
            ...
            $form.find('.addEditionBlock ._addNewPublication').live('click', function () {
                ...
                if (($inputName.val().length > 0)) {
                    ...
                    $inputDate = $addBlock.find('.dateDoor._datepicker');
                    ...
                    if ($targetsList.length > 0) {
                        ...
                        var date = "";
                        if ($inputDate.text().indexOf('.') > -1) {
                            var mass = $inputDate.text().split('.');
                            date = ", " + ConvertMonth(mass[1]) + " `";
                            date = date + mass[2].substr(2);
                        }
                        ...
                        SetCreationParam($item, 'DatePublication', $inputDate.text());
