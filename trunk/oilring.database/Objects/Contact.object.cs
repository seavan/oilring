...
using Database.Interfaces;
    ...
    [MetadataTypeAttribute(typeof(ContactMeta
  ))]
    public partial class ContactObject : DatabaseEntity, IDatabaseEntity
    {
    ...
    public class Converter : IConvertibleFactory<Contact, ContactObject>
    {
    public Converter()
    {
    ...
    #region IConvertibleFactory<Contact, ContactObject> Members
    ...
    public System.Linq.Expressions.Expression<Func<Contact, ContactObject>> GetConverter()
    {
    return (db) => new ContactObject()
    {
    Id = db.Id,
    ...
    ContactType = db.ContactType,
    

    };
    }

    public Action<ContactObject, Contact> GetModelConverter()
    {
    return (param, target) =>
    {
        ...
        target.ContactType = param.ContactType;
    ...
    public static Func<Contact, ContactObject> CONVERT;
    public static Action<ContactObject, Contact> MODEL_CONVERT;
