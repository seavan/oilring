    ...
    File name: 	Conference.object.cs
    */
...
using Database.Interfaces;
    ...
    [MetadataTypeAttribute(typeof(ConferenceMeta
  ))]
    public partial class ConferenceObject : DatabaseEntity, IDatabaseEntity
    {
    ...
    public class Converter : IConvertibleFactory<Conference, ConferenceObject>
    {
    public Converter()
    {
    ...
    #region IConvertibleFactory<Conference, ConferenceObject> Members

    public DataLoadOptions GetOptions()
    {
      var dlo = new DataLoadOptions();
    
      dlo.LoadWith<Conference>( s => s.Comments );
    
      dlo.LoadWith<Conference>( s => s.FileAttachments );
    
      dlo.LoadWith<Conference>( s => s.Photos );
    
      dlo.LoadWith<Conference>( s => s.Reports );
    
    return dlo;
    }


    public System.Linq.Expressions.Expression<Func<Conference, ConferenceObject>> GetConverter()
    {
    return (db) => new ConferenceObject()
    {
    Id = db.Id,
    ...
    public Action<ConferenceObject, Conference> GetModelConverter()
    {
    return (param, target) =>
    {
    ...
    public static Func<Conference, ConferenceObject> CONVERT;
    public static Action<ConferenceObject, Conference> MODEL_CONVERT;
