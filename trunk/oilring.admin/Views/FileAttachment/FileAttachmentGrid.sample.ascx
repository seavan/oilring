            ...
            c =>
                {
						...
						c.Bound(col => col.IsConversionRequired).Width(80);
					
						c.Bound(col => col.IsConverted).Width(80);
					
						c.Bound(col => col.IsConversionInProgress).Width(80);
					
						c.Bound(col => col.Content).Width(80);
					
						c.Bound(col => col.IsError).Width(80);
