            ...
            c =>
                {
						...
						c.Bound(col => col.REL_Entity_ID).Width(80);
					
						c.Bound(col => col.REL_Entity_ObjectType).Width(80);
					
						c.Bound(col => col.REL_User_ID).Width(80);
					
						c.Bound(col => col.REL_User_ObjectType).Width(80);
					
						c.Bound(col => col.IsAccepted).Width(80);
					
						c.Bound(col => col.IsDenied).Width(80);
