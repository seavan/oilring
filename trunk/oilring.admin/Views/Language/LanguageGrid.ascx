...
<%
    Html.Telerik().Grid<admin.db.LanguageObject>()
        .Name("t_Language")
        .DataBinding(dataBinding => dataBinding.Ajax().
                                        Select("_Select", "Language").
                                        Update("_Update", "Language").
                                        Insert("_Insert", "Language").
                                        Delete("_Delete", "Language")
        )
            ...
            c =>
                {
					...
					c.Bound( col => col.Id ).Width(100).Edit("Language");
                    c.Command(cmd =>
                                  {
                                      cmd.Delete();
                                  }
